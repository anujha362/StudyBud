...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    @Query(value = "SELECT new com.project.studybud.models.ReviewList(r.reviewID, p.postID, p.student.cID, p.student.sID, p.student.firstName, p.student.lastName, p.title, r.rate) \n" +
            "FROM Post p " +
            ...
            "UNION \n" +
            "SELECT new com.project.studybud.models.ReviewList(v.reviewID, a.postID, a.student.cID, a.student.sID, a.student.firstName, a.student.lastName, a.title, v.rate) \n" +
            "  FROM Post a \n" +
